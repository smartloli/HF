...
## 1.下载 Hive Falcon
  * [下载地址](https://coding.net/u/smartloli/p/hive-falcon-bin/git/blob/master/hive-falcon-1.0.0-bin.tar.gz)
...
hf.hive.url=jdbc:hive2://master:10000/default&hadoop&hadoop
